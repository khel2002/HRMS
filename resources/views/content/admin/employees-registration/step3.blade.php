{{-- resources/views/employees/create/steps/step-3-family.blade.php --}}
...
<div class="row g-3 mt-1">
  <div class="col-md-6">
    ...
    <input type="text" name="family[father_name]"
      class="form-control @error('family.father_name') is-invalid @enderror" placeholder="Juan dela Cruz Sr."
      value="{{ old('family.father_name') }}">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="family[mother_name]"
      class="form-control @error('family.mother_name') is-invalid @enderror" placeholder="Maria Santos"
      value="{{ old('family.mother_name') }}">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="family[spouse_name]"
      class="form-control @error('family.spouse_name') is-invalid @enderror" placeholder="Ana Santos"
      value="{{ old('family.spouse_name') }}">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="family[spouse_occupation]"
      class="form-control @error('family.spouse_occupation') is-invalid @enderror" placeholder="Teacher"
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="family[spouse_employer]"
      class="form-control @error('family.spouse_employer') is-invalid @enderror" placeholder="DepEd"
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="family[spouse_business_address]"
      ...
      placeholder="123 School St., Manila" value="{{ old('family.spouse_business_address') }}">
...
<div class="row g-3 mt-1">
  <div class="col-md-4">
    ...
    <input type="text" name="family[emergency_contact_name]"
      class="form-control @error('family.emergency_contact_name') is-invalid @enderror" placeholder="Maria Santos"
  ...
  <div class="col-md-4">
    ...
    <input type="text" name="family[emergency_contact_number]"
      class="form-control @error('family.emergency_contact_number') is-invalid @enderror" placeholder="+63 917 000 0000"
  ...
  <div class="col-md-4">
    ...
    <input type="text" name="family[emergency_relationship]"
      class="form-control @error('family.emergency_relationship') is-invalid @enderror" placeholder="Mother"
      value="{{ old('family.emergency_relationship') }}">
...
<div id="childrenContainer">
  ...
  @empty
    {{-- empty by default, user adds dynamically --}}
  @endforelse
</div>
