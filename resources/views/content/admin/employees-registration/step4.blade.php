      ...
      <div class="row g-3">
        <div class="col-md-8">
          ...
          <input type="text" name="education[{{ $i }}][school_name]"
            ...
            placeholder="e.g. San Lorenzo Elementary School" value="{{ $edu['school_name'] ?? '' }}" required>
...
<div class="wz-section-label">
  ...
  <code>employee_government_ids</code>
</div>
      ...
      <div class="govid-row row g-2 align-items-center mt-2">
        <div class="col-md-10">
          <input type="text" name="gov_ids[{{ $i }}][name]" class="form-control"
            placeholder="e.g. SSS No. 12-3456789-0" value="{{ $gid['name'] }}">
        </div>
        <div class="col-md-2">
