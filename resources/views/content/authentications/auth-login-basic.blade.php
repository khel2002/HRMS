            ...
            <div class="card p-sm-7 p-2">
                ...
                <div class="app-brand justify-content-center mt-5">
                    <a href="{{ url('/') }}" class="app-brand-link gap-3">
                        <span class="app-brand-logo demo"><img src="{{ asset('assets/img/logo/HRIS-LOGO.png') }}" class="logo" style=" width: 50px; height: auto;"></span>
                ...
                <div class="card-body mt-1">
                    ...
                    <p class="mb-5">Please sign-in to your account using username.</p>
